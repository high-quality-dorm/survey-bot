...
class Answers(Base):
    ...
    question: Mapped["Questions"] = relationship(back_populates="answers",foreign_keys=[question_id])
...
class Questions(Base):
    ...
    answers: Mapped[list["Answers"]] = relationship(back_populates="question",foreign_keys=[Answers.question_id])
